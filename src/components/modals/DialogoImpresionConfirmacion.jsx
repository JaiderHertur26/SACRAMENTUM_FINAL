            ...
            <form onSubmit={handleSubmit} className="space-y-6 w-full">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input 
                            ...
                            className="py-6 font-bold uppercase border-slate-200 focus:ring-red-600/20"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <select 
                                className="w-full h-[50px] px-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-red-600/20 outline-none bg-white font-medium text-sm transition-all"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                max="10"
                                required
                                className="h-[50px] text-center font-bold border-slate-200 focus:ring-red-600/20"
                    ...
                    <div 
                        className={`flex items-center gap-3 p-4 rounded-xl border transition-all cursor-pointer select-none ${formData.incluirNotaAdicional ? 'bg-red-50 border-red-200' : 'bg-slate-50 border-slate-100 hover:border-slate-200'}`}
                        onClick={() => setFormData({...formData, incluirNotaAdicional: !formData.incluirNotaAdicional})}
                    >
                        <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${formData.incluirNotaAdicional ? 'bg-red-600 border-red-600' : 'bg-white border-slate-300'}`}>
                            {formData.incluirNotaAdicional ? <CheckSquare className="w-4 h-4 text-white" /> : <Square className="w-4 h-4 text-transparent" />}
                        </div>
                        <div className="flex-1">
                            <p className="text-xs font-bold text-slate-800">Incluir espacio para notas adicionales</p>
                            <p className="text-[10px] text-slate-500 leading-tight">Agrega líneas en blanco para hacer anotaciones manuales en el documento físico.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                    <Button 
                        ...
                        variant="ghost" 
                        onClick={onClose}
                        className="text-slate-400 font-bold uppercase tracking-widest text-[10px] hover:bg-slate-100"
                    >
