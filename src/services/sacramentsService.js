...
export const purificarRegistroBautismo = (raw) => {
    ...
    const purificado = {
        ...
        source: recordSource,
        historicalEntryMode: rawPayload.historicalEntryMode || rawPayload.historical_entry_mode || 'structured',
        referenceName: rawPayload.referenceName || rawPayload.reference_name || '',
        literalTranscription: rawPayload.literalTranscription || rawPayload.literal_transcription || '',
