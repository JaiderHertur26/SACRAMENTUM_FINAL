...
const dbPath='C:\\Users\\ASUS\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\v15xmt1n.default-release\\storage\\default\\http+++127.0.0.1+5173\\ls\\data.sqlite';
...
for(const x of rows) console.log(JSON.stringify({
