-- SACRAMENTUM · BAUTISMO · CONSECUTIVOS INMUTABLES
-- Refuerza save_baptism_parameters sin cambiar su firma pública.
...
begin
  ...
  v_new:=public.sacramentum_default_baptism_params()||v_current||v_input;
