-- SACRAMENTUM V58 · Reconciliación legacy compatible con las dos columnas históricas de decanato
-- Usa decanate_id -> decanatos como jerarquía vigente y deja deanery_id -> deaneries sin asignar.
...
is 'Crea una parroquia moderna desde identidad legacy verificada, exige Vicaría y Decanato vigentes y usa decanate_id como jerarquía territorial actual. Sólo rol Diócesis.';
