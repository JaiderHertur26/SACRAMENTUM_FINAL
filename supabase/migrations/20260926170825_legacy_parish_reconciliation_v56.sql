-- SACRAMENTUM V56 · Reconciliación segura de parroquias desde instalaciones legacy
-- Permite a la Diócesis crear una parroquia moderna exclusivamente desde una identidad SACRAMENTA preservada y verificada.
...
begin
  ...
  set metadata = coalesce(metadata, '{}'::jsonb)
        || jsonb_build_object(
          ...
          'hierarchy_pending', (p_vicary_id is null or p_deanery_id is null),
...
is 'Crea una parroquia moderna desde una identidad legacy verificada y vincula de forma atómica toda la instalación preservada. Sólo rol Diócesis.';
